...
function level3() {
  ...
  const platforms = [
    ...
    { x: 4650, y: 220, w: 100, h: 16 },
    { x: 4850, y: groundY, w: 150, h: 60 },
    { x: 500, y: 160, w: 60, h: 80 },
    { x: 1350, y: 140, w: 60, h: 100 },
    { x: 2150, y: 130, w: 60, h: 90 },
    { x: 2950, y: 140, w: 60, h: 80 },
    { x: 3750, y: 150, w: 60, h: 70 },
    { x: 4550, y: 140, w: 60, h: 80 },
  ];
